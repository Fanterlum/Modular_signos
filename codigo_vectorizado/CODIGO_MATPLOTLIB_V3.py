...
img = cv2.imread('IMG\RECORTE_5.png')
...
cv2.imwrite('IMG\CONTORNO_5.png', contour_img)
...
contour_img = cv2.imread('IMG\CONTORNO_5.png', cv2.IMREAD_UNCHANGED)
...
# Guardar la imagen del contorno en un archivo con canal alfa
cv2.imwrite('IMG\CONTORNO_5.png', filtered_mask)
