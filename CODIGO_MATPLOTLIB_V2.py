...
cv2.imwrite('IMG\contorno1.png', contour_img)
...
contour_img = cv2.imread('IMG\contorno1.png', cv2.IMREAD_UNCHANGED)
...
# Guardar la imagen del contorno en un archivo con canal alfa
cv2.imwrite('IMG\contorno1.png', filtered_mask)
