...
def detect_highest_peaks(image_path, threshold=0.5, peak_height=100):
    ...
    peaks, _ = find_peaks(-binary_image.flatten(), distance=image.shape[1] // 10, height=-peak_height)
