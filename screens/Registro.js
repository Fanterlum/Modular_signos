...
import SetUser from '../backend/SetUser';
import SetDoctor from '../backend/SetDoctor';
/*
  Requerimientos al backend
  Es necesaria una funcion que agregue los datos ingresados por el usuario
  a su tabla correspondiente, como podria ser pacientes o doctores
*/
  ...
  const handleRegistro = () => {
    ...
    if (esFormularioValido) {
      if (!Tipo_Usuario) {
        ...
        SetUser(Nombre,Apellidos,Correo,password,Tipo_Usuario);
        if (Tipo_Usuario === "Doctor") {
          datos += `Cedula: ${Cedula}\nEspecialidad: ${Especialidad}\n`;
          SetDoctor(Nombre,Apellidos,Correo,password,Tipo_Usuario);
        }
